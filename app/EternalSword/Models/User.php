...
class User extends BaseModel implements UserInterface, RemindableInterface {
	...
	public function published_records() {
		return $this->hasMany('\App\EternalSword\Models\Record', 'publisher_id');
	}

	public function authored_records() {
		return $this->hasMany('\App\EternalSword\Models\Record', 'author_id');
	}

	public function published_revisions() {
		return $this->hasMany('\App\EternalSword\Models\Revision', 'publisher_id');
	}

	public function authored_revisions() {
		return $this->hasMany('\App\EternalSword\Models\Revision', 'author_id');
	}

	public function groups() {
		return $this->belongsToMany('\App\EternalSword\Models\Group')->withPivot(array('site_id'));
	}
