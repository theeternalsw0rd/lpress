...
@section('content')
	...
	@if($is_root)
		...
		<h2>{{ Lang::get('l-press::headers.model_management', array('model' => 'Site')) }} {{ HTML::new_model_link($new_site) }}</h2>
		...
		<h2>{{ Lang::get('l-press::headers.model_management', array('model' => 'User')) }} {{ HTML::new_model_link($new_user) }}</h2>
